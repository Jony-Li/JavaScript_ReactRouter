...
(function(process) {
  'use strict';
  (function(ea, l) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = l(require('react')) : "function" === typeof define && define.amd ? define(["react"], l) : ea.ReactDOM = l(ea.React);
  })(this, function(ea) {
    function l(a) {
    ...
    function Qc(a, b) {
      if (Rc.hasOwnProperty(a) || 2 < a.length && ("o" === a[0] || "O" === a[0]) && ("n" === a[1] || "N" === a[1]))
        return !1;
      if (null === b)
        return !0;
      switch (typeof b) {
          ...
          if (!qa[c]) {
            ...
            for (var d in c) {
              ...
              if (h) {
                ...
                f.registrationName ? (Tc(f.registrationName, g, k), e = !0) : e = !1;
              e ? void 0 : l("98", d, a);
            }
          }
        }
    ...
    function Tc(a, b, c) {
      ra[a] ? l("100", a) : void 0;
      ra[a] = b;
      gb[a] = b.eventTypes[c].dependencies;
    }
    function Uc(a) {
      fb ? l("101") : void 0;
      fb = Array.prototype.slice.call(a);
      Sc();
    }
    function Vc(a) {
      var b = !1,
 ...
 while (a && 5 !== a.tag);
    ...
    function ad(a, b, c) {
      if (b = Lb(a, c.dispatchConfig.phasedRegistrationNames[b]))
    ...
    function bf(a, b) {
      if (Aa)
        return "topCompositionEnd" === a || !Rb && id(a, b) ? (a = dd(), G._root = null, G._startText = null, G._fallbackText = null, Aa = !1, a) : null;
      switch (a) {
        case "topPaste":
          return null;
        case "topKeyPress":
    ...
    function nd(a) {
      if (a = od(a)) {
        ib && "function" === typeof ib.restoreControlledState ? void 0 : l("194");
        var b = Mb(a.stateNode);
        ib.restoreControlledState(a.stateNode, a.type, b);
      }
    }
    function pd(a) {
    ...
    function rd(a) {
      ...
      return "input" === b ? !!cf[a.type] : "textarea" === b ? !0 : !1;
    }
    function Vb(a) {
    ...
    function Ea(a, b) {
      if (!H.canUseDOM || b && !("addEventListener" in document))
        return !1;
      b = "on" + a;
      var c = b in document;
    ...
    function lf(a) {
      ...
      return b.getModifierState ? b.getModifierState(a) : (a = mf[a]) ? !!b[a] : !1;
    }
    function Wb(a) {
      return lf;
    }
    ...
    function Ad(a) {
      var b = a.alternate;
      if (!b)
        return b = Na(a), 3 === b ? l("188") : void 0, 1 === b ? null : a;
      for (var c = a,
          d = b; ; ) {
        var e = c["return"],
    ...
    function ob(a) {
      ...
      var b = Z[a],
          c;
      for (c in b)
        if (b.hasOwnProperty(c) && c in Cd)
          return Zb[a] = b[c];
      return "";
    }
    function Dd(a) {
      Object.prototype.hasOwnProperty.call(a, pb) || (a[pb] = rf++, Ed[a[pb]] = {});
      return Ed[a[pb]];
    }
    function Fd(a, b) {
    ...
    function xb(a, b) {
      ...
      a = a !== d ? a : null;
      null === a ? wb(d, b) : null === d.last || null === a.last ? (wb(d, b), wb(a, b)) : (wb(d, b), a.last = b);
    }
    function be(a, b, c, d) {
      a = a.partialState;
    ...
    function mc(a, b) {
      ...
      function f(b, c, d) {
        if (a)
          return b = ub(b, c, d), b.index = 0, b.sibling = null, b;
        b.expirationTime = d;
        b.effectTag = 0;
        b.index = 0;
        b.sibling = null;
      ...
      function h(a, b, c, d) {
        if (null === b || 6 !== b.tag)
          return b = fc(c, a.internalContextTag, d), b["return"] = a, b;
        b = f(b, c, d);
        b["return"] = a;
        return b;
      }
      function Fa(a, b, c, d) {
        if (null !== b && b.type === c.type)
          return d = f(b, c.props, d), d.ref = Va(b, c), d["return"] = a, d;
      ...
      function A(a, b, c, d) {
        if (null === b || 7 !== b.tag)
          return b = gc(c, a.internalContextTag, d), b["return"] = a, b;
        b = f(b, c, d);
        b["return"] = a;
        return b;
      }
      function D(a, b, c, d) {
        if (null === b || 9 !== b.tag)
          return b = hc(c, a.internalContextTag, d), b.type = c.value, b["return"] = a, b;
        b = f(b, null, d);
        b.type = c.value;
        b["return"] = a;
        return b;
      ...
      function t(a, b, c, d) {
        if (null === b || 4 !== b.tag || b.stateNode.containerInfo !== c.containerInfo || b.stateNode.implementation !== c.implementation)
          return b = ic(c, a.internalContextTag, d), b["return"] = a, b;
        b = f(b, c.children || [], d);
        b["return"] = a;
        return b;
      }
      function K(a, b, c, d, e) {
        if (null === b || 10 !== b.tag)
          return b = vb(c, a.internalContextTag, d, e), b["return"] = a, b;
        b = f(b, c, d);
        b["return"] = a;
        return b;
      }
      function L(a, b, c) {
        if ("string" === typeof b || "number" === typeof b)
          return b = fc("" + b, a.internalContextTag, c), b["return"] = a, b;
        if ("object" === typeof b && null !== b) {
          switch (b.$$typeof) {
            case Wa:
              if (b.type === ua)
                return b = vb(b.props.children, a.internalContextTag, c, b.key), b["return"] = a, b;
          ...
          if (zb(b) || Ua(b))
            return b = vb(b, a.internalContextTag, c, null), b["return"] = a, b;
          yb(a, b);
        }
        return null;
      }
      ...
      function ee(a, b, c, d, e) {
        ...
        if ("object" === typeof d && null !== d) {
          ...
          if (zb(d) || Ua(d))
            return a = a.get(c) || null, K(b, a, d, e, null);
          yb(b, d);
        }
        return null;
      }
      function p(a, f, y, k) {
        ...
        if (null === m) {
          for (; v < y.length; v++)
            if (m = L(a, y[v], k))
              f = g(m, f, v), null === h ? q = m : h.sibling = m, h = m;
          return q;
        }
        for (m = e(a, m); v < y.length; v++)
          if (l = ee(m, a, v, y[v], k)) {
            if (b && null !== l.alternate)
              m["delete"](null === l.key ? v : l.key);
            f = g(l, f, v);
      ...
      function n(a, f, y, k) {
        ...
        for (var h = q = null,
            ...
            v = f = 0,
            Fa = null,
            x = y.next(); null !== m && !x.done; v++, x = y.next()) {
        ...
        for (m = e(a, m); !x.done; v++, x = y.next())
          if (x = ee(m, a, v, x.value, k), null !== x) {
            if (b && null !== x.alternate)
              m["delete"](null === x.key ? v : x.key);
            f = g(x, f, v);
            null === h ? q = x : h.sibling = x;
            h = x;
          }
      ...
      return function(a, b, e, g) {
        ...
        if ("string" === typeof e || "number" === typeof e)
          return e = "" + e, null !== b && 6 === b.tag ? (d(a, b.sibling), e = f(b, e, g)) : (d(a, b), e = fc(e, a.internalContextTag, g)), e["return"] = a, a = e, k(a);
        if (zb(e))
          return p(a, b, e, g);
        if (Ua(e))
          return n(a, b, e, g);
    ...
    function uc(a, b, c) {
      b && (yf[a] && (null != b.children || null != b.dangerouslySetInnerHTML ? l("137", a, c()) : void 0), null != b.dangerouslySetInnerHTML && (null != b.children ? l("60") : void 0, "object" === typeof b.dangerouslySetInnerHTML && "__html" in b.dangerouslySetInnerHTML ? void 0 : l("61")), null != b.style && "object" !== typeof b.style ? l("62", c()) : void 0);
    }
    function vc(a, b) {
      if (-1 === a.indexOf("-"))
      ...
      for (g in d) {
        ...
        if (d.hasOwnProperty(g) && h !== b && (null != h || null != b))
          if ("style" === g)
            ...
            "dangerouslySetInnerHTML" === g ? (h = h ? h.__html : void 0, b = b ? b.__html : void 0, null != h && b !== h && (f = f || []).push(g, "" + h)) : "children" === g ? b === h || "string" !== typeof h && "number" !== typeof h || (f = f || []).push(g, "" + h) : "suppressContentEditableWarning" !== g && "suppressHydrationWarning" !== g && (ra.hasOwnProperty(g) ? (null != h && ba(e, g), f || b === h || (f = [])) : (f = f || []).push(g, h));
      }
      a && (f = f || []).push("style", a);
      return f;
    }
      ...
      style: !0
        ...
        ze = {
          ...
          injectDOMPropertyConfig: function(a) {
            ...
            for (var f in c) {
              eb.hasOwnProperty(f) ? l("48", f) : void 0;
              var g = f.toLowerCase(),
                  k = c[f];
              g = {
                attributeName: g,
    ...
    "accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode x-height xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type xml:base xmlns:xlink xml:lang xml:space".split(" ").forEach(function(a) {
      var b = a.replace(Bf, Cf);
      Ac.Properties[b] = 0;
      Ac.DOMAttributeNames[b] = a;
    });
    X.injectDOMPropertyConfig(Af);
    ...
    var u = {
      ...
      clearCaughtError: function() {
        ...
        Ef = Object.freeze({
          ...
          registrationNameDependencies: gb,
        ...
        va = function() {};
    va.thatReturns = hb;
    va.thatReturnsFalse = hb(!1);
    va.thatReturnsTrue = hb(!0);
    va.thatReturnsNull = hb(null);
    ...
    fd(n);
    n.augmentClass(gd, {data: null});
    n.augmentClass(hd, {data: null});
    var $e = [9, 13, 27, 32],
        Rb = H.canUseDOM && "CompositionEvent" in window,
        ab = null;
    H.canUseDOM && "documentMode" in document && (ab = document.documentMode);
    var If = H.canUseDOM && "TextEvent" in window && !ab && !Ze(),
        ...
        Jf = {
          ...
          extractEvents: function(a, b, c, d) {
            ...
            if (Rb)
              ...
              Aa ? id(a, c) && (f = ca.compositionEnd) : "topKeyDown" === a && 229 === c.keyCode && (f = ca.compositionStart);
            ...
            (a = If ? af(a, c) : bf(a, c)) ? (b = hd.getPooled(ca.beforeInput, b, c, d), b.data = a, za(b)) : b = null;
            return [e, b];
          }
        },
        ib = null,
        Da = null,
        ia = null,
        He = {injectFiberControlledHostComponent: function(a) {
            ib = a;
          }},
        Kf = Object.freeze({
          injection: He,
    ...
    var Lf = {
      ...
      extractEvents: function(a, b, c, d) {
        ...
        if ("select" === f || "input" === f && "file" === e.type)
          ...
          f = e.nodeName, !f || "input" !== f.toLowerCase() || "checkbox" !== e.type && "radio" !== e.type || (g = jf);
        if (g && (g = g(a, b)))
          return vd(g, c, d);
        k && k(a, e, b);
    ...
    var pe = {
      topAbort: "abort",
      topAnimationEnd: ob("animationend") || "animationend",
      topAnimationIteration: ob("animationiteration") || "animationiteration",
      topAnimationStart: ob("animationstart") || "animationstart",
      topBlur: "blur",
      topCancel: "cancel",
      topCanPlay: "canplay",
      ...
      topTransitionEnd: ob("transitionend") || "transitionend",
      ...
      topWheel: "wheel"
        ...
        cc = function(a, b) {
          ...
          for (d = 0; d < c.length; d++)
            if (!Of.call(b, c[d]) || !Fd(a[c[d]], b[c[d]]))
              return !1;
          return !0;
        },
        Hd = function(a) {
        ...
        Qf = {
          ...
          extractEvents: function(a, b, c, d) {
            ...
            switch (a) {
              case "topFocus":
                if (rd(e) || "true" === e.contentEditable)
                  ka = e, dc = b, Pa = null;
                break;
              case "topBlur":
                Pa = dc = ka = null;
    ...
    n.augmentClass(Nd, {clipboardData: function(a) {
        return "clipboardData" in a ? a.clipboardData : window.clipboardData;
      }});
    ja.augmentClass(Od, {relatedTarget: null});
    var Rf = {
      Esc: "Escape",
      Spacebar: " ",
      Left: "ArrowLeft",
    ...
    U.augmentClass(Qd, {dataTransfer: null});
    ja.augmentClass(Rd, {
      touches: null,
      targetTouches: null,
      changedTouches: null,
        ...
        Uf = function(a, b, c, d) {
          ...
          return {
            ...
            updateClassInstance: function(a, b, e) {
              ...
              if (!(k !== h || t !== e || J.current || null !== b.updateQueue && b.updateQueue.hasForceUpdate))
                return "function" !== typeof g.componentDidUpdate || k === a.memoizedProps && t === a.memoizedState || (b.effectTag |= 4), !1;
              var L = h;
    ...
    if ("function" === typeof Symbol && Symbol["for"]) {
      ...
      Wa = 60103, Xa = 60104, Ya = 60105, ua = 60107;
    var Ec = mc(!0, !0),
        Fc = mc(!1, !0),
        Gc = mc(!1, !1),
        Vf = function(a, b, c, d, e) {
          ...
          function A(a, b) {
            ...
            if (null !== b.child) {
              a = b.child;
              var c = ub(a, a.pendingProps, a.expirationTime);
              b.child = c;
            ...
            beginWork: function(a, b, c) {
              ...
              switch (b.tag) {
                case 0:
                  ...
                  d = d(e, g);
                  b.effectTag |= 1;
                  "object" === typeof d && null !== d && "function" === typeof d.render ? (b.tag = 2, e = tb(b), q(b, d), z(b, c), b = h(a, b, !0, e)) : (b.tag = 1, f(a, b, d), b.memoizedProps = e, b = b.child);
                  return b;
                case 1:
                  a: {
                    e = b.type;
                  ...
                  return b;
                case 2:
                  return e = tb(b), d = void 0, null === a ? b.stateNode ? l("153") : (y(b, b.pendingProps), z(b, c), d = !0) : d = uf(a, b, c), h(a, b, d, e);
                case 3:
        ...
        Wf = function(a, b, c) {
          ...
          var e = a.createInstance,
              ...
              B = void 0,
              v = void 0;
          a.mutation ? (w = function(a) {}, B = function(a, b, c, e, f, g, k) {
            (b.updateQueue = c) && d(b);
          }, v = function(a, b, c, e) {
            c !== e && d(b);
          }) : p ? l("235") : l("236");
        ...
        Xf = function(a, b) {
          ...
          function g(a) {
            for (var b = a,
              ...
              if (5 === b.tag || 6 === b.tag)
                e(b), g ? B(f, b.stateNode) : w(f, b.stateNode);
          ...
          return {
            ...
            commitPlacement: function(a) {
              ...
              for (var e = a; ; ) {
                if (5 === e.tag || 6 === e.tag)
                  c ? d ? u(b, e.stateNode, c) : aa(b, e.stateNode, c) : d ? L(b, e.stateNode) : n(b, e.stateNode);
        ...
        ag = function(a) {
            ...
            for (r = c; null !== r; ) {
              ...
              try {
                for (; null !== r; ) {
                  ...
                  h & 128 && ua(r);
                  if (h & 64)
                    switch (e = r, f = void 0, null !== S && (f = S.get(e), S["delete"](e), null == f && null !== e.alternate && (e = e.alternate, f = S.get(e), S["delete"](e))), null == f ? l("184") : void 0, e.tag) {
                      case 2:
          ...
          function k(a, b) {
            ...
            if (3 === a.tag)
              ...
              for (var g = a["return"]; null !== g && null === c; ) {
                ...
                if (n(g)) {
                  if (ka || null !== wa && (wa.has(g) || null !== g.alternate && wa.has(g.alternate)))
                    return null;
                  c = null;
                  e = !1;
                }
              ...
              do {
                a: switch (g.tag) {
                  ...
                  case 5:
                    ...
                    k && (cb = Ma(k));
                    k = l;
                    m = "\n    in " + (m || "Unknown") + (k ? " (at " + k.fileName.replace(/^.*[\\\/]/, "") + ":" + k.lineNumber + ")" : cb ? " (created by " + cb + ")" : "");
                    break a;
                  default:
                    m = "";
                }
              ...
              if (null === a["return"])
                if (3 === a.tag) {
                  ...
                  if (null === c.nextScheduledRoot)
                    c.remainingExpirationTime = d, null === O ? (Ia = O = c, c.nextScheduledRoot = c) : (O = O.nextScheduledRoot = c, O.nextScheduledRoot = Ia);
                  else {
              ...
              for (var c = O,
                ...
                if (0 === e) {
                  ...
                  if (d === d.nextScheduledRoot) {
                    ...
                    Ia = e = d.nextScheduledRoot, O.nextScheduledRoot = e, d.nextScheduledRoot = null;
                  else if (d === O) {
                    O = c;
          ...
          function v(a, c) {
            ...
            if (c <= B()) {
              ...
              d = a.finishedWork, null !== d ? (a.finishedWork = null, a.remainingExpirationTime = b(d)) : (a.finishedWork = null, d = g(a, c), null !== d && (q() ? a.finishedWork = d : a.remainingExpirationTime = b(d)));
            R = !1;
          }
          function q() {
        ...
        Ke = function(a) {
          ...
          return {
            ...
            updateContainer: function(a, b, c, n) {
              var g = b.current;
              if (c) {
                c = c._reactInternalFiber;
                var h;
        ...
        Me = "object" === typeof performance && "function" === typeof performance.now,
        Ne = void 0;
    Ne = Me ? function() {
    ...
    if (H.canUseDOM)
      if ("function" !== typeof requestIdleCallback) {
        var Kc = null,
            ...
            Hb = 33,
            db = 33;
        var cg = Me ? {timeRemaining: function() {
            return Gb - performance.now();
          }} : {timeRemaining: function() {
            return Gb - Date.now();
          }};
        var Oe = "__reactIdleCallback$" + Math.random().toString(36).slice(2);
        ...
        var dg = function(a) {
          Mc = !1;
          var b = a - Gb + db;
          b < db && Hb < db ? (8 > b && (b = 8), db = b < Hb ? Hb : b) : Hb = b;
          Gb = a + db;
          Lc || (Lc = !0, window.postMessage(Oe, "*"));
        };
        Fb = function(a) {
          Kc = a;
          Mc || (Mc = !0, requestAnimationFrame(dg));
          return 0;
        };
      } else
        Fb = requestIdleCallback;
    else
      Fb = function(a) {
        setTimeout(function() {
    ...
    H.canUseDOM && ("textContent" in document.documentElement || (Pe = function(a, b) {
      if (3 === a.nodeType)
        a.nodeValue = b;
      else {
    ...
    He.injectFiberControlledHostComponent(gg);
    var Nc = null,
        Oc = null,
        F = bg({
    ...
    var Qe = {
      ...
      __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: {
        EventPluginHub: Ff,
        EventPluginRegistry: Ef,
        EventPropagators: Gf,
        ReactControlledComponent: Kf,
        ReactDOMComponentTree: Fe,
        ReactDOMEventListener: Nf
      }
    };
    ...
    var Re = Object.freeze({default: Qe}),
        Pc = Re && Qe || Re;
